...
define(["jquery", "touch", "jquery.hotkeys", "jquery.bbq",
  ...
  if (!window.methodDraw) window.methodDraw = function($) {
    ...
    Editor.setSession = function(_session_) {
      session = _session_;
    };

    Editor.getSession = function() {
      return session;
    };

    Editor.setView = function(_view_) {
      view = _view_;
    };
    ...
    Editor.init = function() {
      ...
      var setImageURL = Editor.setImageURL = function(url) {
        ...
        $('#image_url').val(url.replace(session.templateFolder + '/', ""));
      };
      ...
      $('.path_changer').change(function() {
        ...
        var val = $(this).val();
        svgCanvas.clearSelection();
        $(elem).attr("xlink:href", session.templateFolder + '/' + val);
      ...
      setTimeout(function() {
        svgCanvas.embedImage('editor/images/placeholder.svg', function(datauri) {
          if (!datauri) {
            // Disable option
