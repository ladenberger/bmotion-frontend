...
define([
  ...
  return angular.module('prob.graph', ['bms.visualization', 'bms.observers', 'bms.common'])
    .factory('bmsRenderingService', ['$q', 'ws', '$injector', 'bmsModalService', 'bmsObserverService', 'bmsVisualizationService', '$http', '$templateCache', '$compile', '$rootScope', '$interpolate', '$timeout', 'bmsErrorService',
      function($q, ws, $injector, bmsModalService, bmsObserverService, bmsVisualizationService, $http, $templateCache, $compile, $rootScope, $interpolate, $timeout, bmsErrorService) {
